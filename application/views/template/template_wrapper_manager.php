          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="menuDropdown">
                <a class="dropdown-item" href="<?=base_url().'t/db';?>">
                  <i class="fas fa-tachometer-alt fa-sm fa-fw mr-2 text-gray-400"></i>
                  Dashboard
                </a>
                <!--<a class="dropdown-item" href="<?=base_url().'t/ps/ps';?>">-->
                <!--  <i class="fas fa-shopping-cart fa-sm fa-fw mr-2 text-gray-400"></i>-->
                <!--  Point of sales-->
                <!--</a>-->
                <a class="dropdown-item" href="<?=base_url().'t/rp/rp/td';?>">
                  <i class="fas fa-calendar fa-sm fa-fw mr-2 text-gray-400"></i>
                  Report
                </a>
                <a class="dropdown-item" href="<?=base_url().'t/pc/pc';?>">
                  <i class="fas fa-box fa-sm fa-fw mr-2 text-gray-400"></i>
                  Purchasing
                </a>
                <a class="dropdown-item" href="<?=base_url().'m/pc/pc/rev';?>">
                  <i class="fas fa-list fa-sm fa-fw mr-2 text-gray-400"></i>
                  Review Purchasing
                </a>
              </div>
